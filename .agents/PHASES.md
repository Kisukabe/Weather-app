...
| **Phase 8** | Web UI (Streamlit Frontend) | `COMPLETED` | `app.py` (Streamlit Dashboard kết nối REST API) |
| **Phase 9** | Decoupled REST API & Docker Packaging | `COMPLETED` | `src/api/main_api.py` (FastAPI), `Dockerfile.backend`, `Dockerfile.frontend`, `docker-compose.yml` |
